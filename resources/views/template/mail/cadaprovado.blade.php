...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #ffffff; font-family: 'Roboto', sans-serif;">
    ...
    <![FIMif]-->
        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: 0 auto;" class="email-container">
            ...
            <!-- Frist Block : INICIO -->
            <tr>
                <td style="background-color: #ffffff; padding: 44px 15% 0 15%;  margin-top: 10px; margin-bottom: 64px;">
                    <p style="text-align: center;"><img class="center-on-narrow" {{asset('assets/mail/cadastro-aprovado-check.svg')}} width="117" height="117" alt="cadastro aprovado"></p>
                    <p style="font-weight: 100; text-align: center; margin-top: 41px; margin-bottom: 0; font-size: 18px; color: #313131;margin-top: 24px; margin-bottom: 8px;">Seu Cadastro foi</p>
                    <h1 style="font-weight: 700; color: #D6EF63; font-style: italic; font-size: 32px; text-align: center;  margin-top: 0; margin-bottom: 24px;">Aprovado</h1>
                    <p style="text-align: center;font-size: 12px;color: #313131;line-height: 20px; margin-bottom: 64px;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec scelerisque egestas enim vel finibus.</p>
