...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #ffffff; font-family: 'Roboto', sans-serif;">
    ...
    <![FIMif]-->
        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: 0 auto;" class="email-container">
            ...
            <tr>
                <td style="background-color: #ffffff; padding: 0 45px;  margin-top: 10px; margin-bottom: 64px;">
                    <p style="font-weight: 400; text-align: center; font-size: 26px; color: #EF2B2B;"><img {{asset('assets/mail/pagcancel.svg')}} width="38" height="38" alt="Compra Cancelada" border="0" style="vertical-align: middle;"> Compra Cancelada</p>
                </td>
            </tr>
            <!-- Frist Block : FIM -->
