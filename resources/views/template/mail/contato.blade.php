        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: 0 auto;" class="email-container">
            ...
            <tr>
                <td style="background-color: #ffffff; padding: 44px 27px 0 27px;">
                    <h1 style="font-weight: 100; margin-top: 0; margin-bottom: 15px; font-size: 18px; color: #1B4E01;">{{$firstName}} {{$lastName}} enviou uma mensagem: </h1>
                    <p>Email: {{$email}}</p>
                    <p>Telefone: {{$phone}}</p>
                    <p style="font-size: 14px;color: #313131;line-height: 20px; margin-bottom: 0;white-space: pre-line;">
                      {{$message}}
                    </p>
                </td>
            </tr>
