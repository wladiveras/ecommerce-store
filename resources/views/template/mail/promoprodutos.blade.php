...
<body width="100%" style=" margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #ffffff; font-family: 'Roboto', sans-serif;">
    ...
    <![FIMif]-->
        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: 0 auto;" class="email-container">
            ...
            <!-- Frist Block : INICIO -->
            <tr style="height: 375px;display: block;">
                <td style="background-color: #ffffff; padding: 0 45px; z-index: 99;">
                    <h1 style="font-weight: 100;text-align: left;margin-top: 41px;margin-bottom: 2px;font-size: 32px;color: #313131;">Olá <span style="font-weight: 700; color: #1B4E01; font-style: italic;">{{$name}}</span></h1>
                
                <p style="font-weight: 400;text-align: left;margin-top: 10px;margin-bottom: 5px;font-size: 12px;color: #313131;z-index: 99;position: absolute;">Em primeiro lugar, gostariamos de</p>
                    <p style="font-weight: 400;text-align: left;margin-top: 30px;font-size: 12px;color: #313131;position: absolute;z-index: 99;">lhe dar as boas-vindas à <span style="color: #1B4E01; font-weight: 700;">Padão Color!</span></p>
                </td>
            </tr>
            <tr>
                <td style="background-image: url(/assets/mail/produto-banner.png);width: 510px;height: 376px;position: absolute;top: 150px;background-repeat: no-repeat;padding: 0 45px;margin-top: 20px;background-color: #fff; z-index: 1">
                    
                    <div class="" style="background-image: url(/assets/mail/patch.svg);width: 140px;height: 140px;position: absolute;top: -60px;right: 20px;background-repeat: no-repeat;"><span style="color: #fff;font-size: 12px;position: absolute;top: 40px;left: 40px;">até</span><span style="color: #fff;font-size: 36px;position: absolute;top: 48px;left: 36px;"> 50%</span> <span style="color: #fff;font-size: 12px;position: absolute;left: 40px;bottom: 40px;">de desconto</span></div> 
                    <div style="position: absolute;top: 200px;"><span style="color: #fff;font-size: 18px;font-weight: 700;">Cartão de Visita</span> <span style="color: #fff;font-size: 14px;text-decoration: line-through;position: absolute;top: 25px;left: 0">R$ 59,90</span><span style="color: #fff;font-size: 32px;position: absolute;top: 44px;left: -2px;">R$ 29,90</span><span style="position: absolute;top: 100px;"><a href="#" style="background-color: #93DA4A;padding: 10px 62px;border-radius: 5px;color: #fff;letter-spacing: 2px;">COMPRAR</a></span></div>   
                </td>
            </tr>
            <!-- Frist Block : FIM -->
            ...
            <tr style="display: block;margin-top: 100px;">
                <td style="background-color: #FFFFFF; padding: 24px 34px 0 34px;">
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                            <td>
                                <div style="text-align: center;border: 2px solid #cdcdcd;padding: 44px 24px;border-radius: 5px;margin-left: 20px;">
                                    <img {{asset('assets/mail/produto1.png')}}>
                                    <h3 style="margin-bottom: 6px; font-size: 14px;color: #313131;text-align: left;">Sacolas de Papel Personalizadas</h3>
                                    <p style="margin: 0; text-align: left;font-size: 12px;color: #909090;">a partir de</p>
                                    <p style="margin-bottom: 24px;text-align: left;margin: 6px 0 24px 0;font-size: 20px;">R$ 59,90</p>
                                    <a href="#" style="background-color: #93DA4A;color: #fff;padding: 10px 60px;font-size: 12px;border-radius: 36px;margin-top: 20px;letter-spacing: 1px;box-shadow: #00000033 0px 0px 6px 1px;">COMPRAR</a>
                                </div>
                            </td>
                            <td>
                                <div style="text-align: center;border: 2px solid #cdcdcd;padding: 44px 24px;border-radius: 5px;margin-left: 20px;">
                                    <img {{asset('assets/mail/produto2.png')}}>
                                    <h3 style="margin-bottom: 6px; font-size: 14px;color: #313131;text-align: left;">Sacolas de Papel Personalizadas</h3>
                                    <p style="margin: 0; text-align: left;font-size: 12px;color: #909090;">a partir de</p>
                                    <p style="margin-bottom: 24px;text-align: left;margin: 6px 0 24px 0;font-size: 20px;">R$ 59,90</p>
                                    <a href="#" style="background-color: #93DA4A;color: #fff;padding: 10px 60px;font-size: 12px;border-radius: 36px;margin-top: 20px;letter-spacing: 1px;box-shadow: #00000033 0px 0px 6px 1px;">COMPRAR</a>
            ...
            <tr style="display: block;margin-top: 0;">
                <td style="background-color: #FFFFFF; padding: 24px 34px 0 34px;">
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                            <td>
