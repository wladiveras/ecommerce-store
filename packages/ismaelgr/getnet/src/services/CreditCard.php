...
class CreditCard
{
    ...
    public function finishTransaction($tokenType, $accessToken)
    {
        ...
        try {
            ...
            //debug_log("Getnet/Creditcard", "Finish Transaction ERROR", ['123', request()->ip()]);
            //debug_log("Getnet/Creditcard", "Finish Transaction ERROR1", [$headers, request()->ip()]);
            //debug_log("Getnet/Creditcard", "Finish Transaction ERROR2", [$params, request()->ip()]);
            //$array['headers'] = $headers;
            //$array['body'] = json_encode($params);
        }
    }
